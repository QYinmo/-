      ...
      <div class="hero-panel__aside">
        <el-card shadow="never" class="status-card status-card--accent">
          <div class="section-heading section-heading--compact">
            ...
            <h2>平台特色</h2>
            <p>聚合红色文化、非遗技艺、赛事活动与公益传播等核心能力，形成统一的数字展示体验。</p>
          </div>
        ...
        <div v-else class="announcements-list">
          <article v-for="item in announcements" :key="item.id" class="announcement-item">
            <div class="announcement-item__meta">
              <el-tag :type="item.type === 'urgent' ? 'danger' : item.type === 'update' ? 'warning' : 'info'" size="small">
...
.entrance-grid::-webkit-scrollbar,
...
.entrance-grid::-webkit-scrollbar-thumb,
.announcements-grid::-webkit-scrollbar-thumb,
.deployment-grid::-webkit-scrollbar-thumb {
